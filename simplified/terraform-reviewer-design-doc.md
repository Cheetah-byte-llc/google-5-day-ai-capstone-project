...
**Version:** 3.0 (MVP - 12-Day Implementation)
...
The Terraform Code Reviewer is an autonomous multi-agent system that analyzes Terraform repositories, generates comprehensive documentation, and validates outputs through agentic evaluation. The system leverages Google's Agent Development Kit (ADK) for multi-agent orchestration, Google's Gemini 2.0 Flash for agent intelligence, and integrates with the Terraform Model Context Protocol (MCP) server for authentic Terraform operations.

**This document describes the complete system architecture with a phased implementation approach.**

### MVP Scope (December 1st Deliverable)

**Phase 1 - Core Demonstration (12 Days):**
- **Repository Analyzer Agent:** Scans and catalogs Terraform code
- **Documentation Generator Agent:** Creates comprehensive module documentation  
- **Evaluation Agent:** Validates outputs using real Terraform operations via MCP
- **End-to-End Pipeline:** Working demo on sample repositories
- **Complete Architecture:** Full system design with implementation roadmap

### Full System Capabilities (Future Phases)
...
- **Comprehensive Evaluation:** Fully automated validation using real Terraform operations
...
### MVP Implementation (Phase 1 - 12 Days)

**Core Components:**
- ✅ Repository Analyzer Agent (WHAT)
- ✅ Documentation Generator Agent (WHAT/WHY/HOW)
- ✅ Evaluation Agent (META)
- ✅ MCP Client Integration
- ✅ Basic Context Management
- ✅ End-to-End Pipeline

**Deferred to Phase 2:**
- ⏳ Cross-Reference Linker Agent
- ⏳ Refinement Agents (Technical Accuracy, Completeness, Clarity)
- ⏳ Usage/Examples Agent
- ⏳ Best Practices Critic Agent
- ⏳ Interactive Session

### Design Philosophy

The system follows a **WHAT → WHY → HOW** progression, with Phase 1 demonstrating the core pattern using 3 essential agents that prove the concept.
...
### Phase 1: Core Demo (12 Days - Target: December 1st)

**What Gets Built:**

1. **Repository Analyzer Agent** (WHAT category)
   - Scans Terraform repository structure
   - Extracts modules, variables, outputs, resources
   - Uses MCP for proper HCL parsing
   - Creates structured inventory

2. **Documentation Generator Agent** (WHAT/WHY/HOW overlap)
   - Takes analyzer output
   - Generates README.md for each module
   - Creates variable/output tables
   - Adds usage instructions

3. **Evaluation Agent** (META category)
   - Validates generated documentation accuracy
   - Tests one example via MCP (terraform validate)
   - Generates metrics and report
...
**Demo Capability:**
- Run on sample Terraform repo
- Generate documentation automatically
- Validate accuracy with real Terraform
...
### Phase 2: Full System (Future - 4-5 Weeks)

**Additional Agents:**
- Cross-Reference Linker (dependency mapping)
- Technical Accuracy Reviewer (validation)
- Completeness Checker (coverage)
- Clarity Enhancer (readability)
- Usage/Examples Agent (working examples)
- Best Practices Critic (security & style)
- Orchestrator Agent (coordination)

**Additional Features:**
- Stage 2b refinement loop with quality scoring
- Parallel agent execution (Stages 1, 2b, 3)
...
#### 2. Cross-Reference Linker Agent ⏳ **Phase 2**
...
#### 3. Technical Accuracy Reviewer Agent ⏳ **Phase 2**
...
#### 4. Completeness Checker Agent ⏳ **Phase 2**
...
#### 5. Clarity Enhancer Agent ⏳ **Phase 2**
...
#### 6. Documentation Generator Agent ✅ **MVP**
...
#### 7. Usage/Examples Agent ⏳ **Phase 2**
...
#### 8. Best Practices Critic Agent ⏳ **Phase 2**
...
### MVP Workflow (Phase 1 - December 1st Deliverable)

```
Input: Terraform Repository
         ↓
┌─────────────────────────────────┐
│  Repository Analyzer Agent      │
│  • Scans structure               │
│  • Extracts modules/vars/outputs│
│  • Uses MCP for parsing          │
└──────────┬──────────────────────┘
           ↓
   [Repository Context]
           ↓
...
**Pipeline Flow:**
1. **Analyze:** Repository Analyzer scans repo (30-60 seconds)
2. **Document:** Documentation Generator creates docs (2-4 minutes)
3. **Evaluate:** Evaluation Agent validates outputs (1-2 minutes)
4. **Report:** Display results to user

**Total Time:** ~4-7 minutes for medium-sized repo

---

### Full System Workflow (Phase 2 - Future)
